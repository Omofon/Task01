...
console.log('You are to guess a number within a range.')
...
// function rand to generate random number
  const rand = () => {
    ...
    if (inputNum == result) {
      point++
      console.log(`You're correct! You have ${point} out of ${stage} points`);
      console.log('')
    };
    if (inputNum !== result) {
      console.log(`You're wrong! You have ${point} out of ${stage} points`);
